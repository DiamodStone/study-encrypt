...
import alvin.encrypt.util.DigestUtil;
...
public class DigestUtilTest {
    ...
    public void test_md5_with_byte() throws Exception {
        DigestUtil digest = new DigestUtil("MD5");
    ...
    public void test_md5_with_stream() throws Exception {
        ...
        Path path = Paths.get(DigestUtilTest.class.getResource("/photo-1.jpg").getFile());
        ...
        path = Paths.get(DigestUtilTest.class.getResource("/photo-2.jpg").getFile());
    ...
    public void test_sha1_with_string() throws Exception {
        DigestUtil digest = new DigestUtil("SHA1");
    ...
    public void test_sha512_with_stream() throws Exception {
        DigestUtil digest = new DigestUtil("SHA-512");
